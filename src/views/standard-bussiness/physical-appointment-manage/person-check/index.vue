<template>
    <div class="container">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>个检预约管理</el-breadcrumb-item>
      </el-breadcrumb>
      <!-- 筛选操作 start -->
            ...
            <el-table
                ...
                >
                    <template slot-scope="scope">
                        ...
                        <el-button
                        size="mini"
                        @click="handleEdit(scope.$index, scope.row),$router.push('/standard-bussiness-data/booking-detail/' + scope.row.id + '/detail/' + scope.row.reservationNo + '/from/0')" class="cursor">详情</el-button>
                    </template>
                </el-table-column>
            </el-table>
          <!-- 分页模块 start -->
...
export default {
  name:"physical-appointment-manage",
  data() {
    return {
      loading: false,
      status: "", //订单状态
