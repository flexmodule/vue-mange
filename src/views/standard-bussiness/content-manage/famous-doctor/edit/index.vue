    ...
    <el-card class="box-card" v-loading="loading">
      <div class="info picture">
        ...
        <div>
          <p>作者：</p>
          <div class="authors">
            <el-select v-model="value6" placeholder="请选择作者" @change="changeAuthor">
              <el-option v-for="item in experts" :key="item.id" :label="item.realName" :value="JSON.stringify(item)" class="author">
                <div class="author">
                  <div class="img">
                    <img :src="item.avatarPath" alt="" width="50px" height="50px">
                  </div>
                  <div>
                    <p>{{ item.realName }}</p>
                    <p>
          ...
          if (res.data.rc === 0) {
              if (status == "published") {
                ...
                if (state) {
                  ...
                  window.location.href= "//test-news.touchealth.com/?id=" +
                      res.data.data.id +
                      "&fromOps=1";
      ...
      this.$http
        ...
        .then(res => {
          if (res.data.rc === 0) {
            ...
            this.value6 = res.data.data.expert.realName;
            this.authorId = res.data.data.expert.id;
